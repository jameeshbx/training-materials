...
export default function Home() {
    ...
    return (
        <div className="flex items-center justify-center w-full min-h-screen px-4 sm:px-6">
            <Card className="w-full max-w-xs sm:max-w-sm md:max-w-md bg-white border border-gray-200 text-gray-900 shadow-2xl p-6 sm:p-8 rounded-lg sm:rounded-xl">
                ...
                {/* ✅ TITLE */}
                <h2 className="text-lg sm:text-xl font-semibold text-center mb-6 sm:mb-8 text-gray-900">
                    {t("login")}
                </h2>
                ...
                <div className="flex flex-col gap-4 sm:gap-5">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <Input
                            ...
                            placeholder={t("email")}
                            type="email"
                            className="bg-white text-gray-900 placeholder-gray-400 border border-gray-400 focus:ring-2 focus:ring-blue-500"
                            value={email}
                    ...
                    {/* ✅ Login Button */}
                    <Button
                        className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 sm:py-3"
                        onClick={handleLogin}
                    >
                        {t("login")}
                    </Button>
                    ...
                    <Link href="/register" className="block">
                        <Button
                            variant="secondary"
                            className="w-full bg-orange-500 hover:bg-orange-600 text-white font-semibold py-2 sm:py-3 rounded-lg transition"
                        >
                            Register
                        </Button>
                    </Link>
